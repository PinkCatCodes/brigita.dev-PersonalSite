    ...
    <section id="heroSection" className="hero--section">
      <div className="hero--section--content--box">
        <div className="hero--section--content">
          <p className="section--title">Hey, I'm Brigita</p>
          ...
          <p className="hero--section-description">
            ...
            technology. <br />
            In active search for intership and professional opportunities with a
            desire to contribute meaningfully to real-world projects.
            <br />
          </p>
        </div>
