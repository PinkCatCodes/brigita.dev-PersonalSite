    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="logo">
          ...
          <span className="letter" style={{ transform: "rotate(-180deg)" }}>
            V
          </span>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>*/}
              <a
                href="https://www.linkedin.com/in/brigita-cepulyte/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by brigita.dev</p>
        <div className="footer--social--icon">
          {/** 
          <ul>
            <li>
